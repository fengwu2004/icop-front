export default {
  route: {
    ...
    assetmanager_repairdetail:'维修详情',
    messagepush_area:'社区通知',
    messagepush_area_edit:'填写内容',
    messagepush_area_create:'录入资产',
    systemadmin:'用户管理',
    projectsetting:'项目账户配置',
    systemadmin_role:'管理员',
    systemadmin_role_create:'创建角色',
    systemadmin_role_detail:'角色详情',
    systemadmin_role_edit:'修改角色',
    systemadmin_repairer:'维修人员',
    systemadmin_repairer_edit:'审核维修人员',
    systemadmin_repairer_detail:'审核维修详情',
    systemadmin_repairer_create:'创建账户',
    systemadmin_repairer_rolesetting:'角色设置',
    dashboard: '首页',
    introduction: '简述',
    documentation: '文档',
    permission: '权限测试页',
